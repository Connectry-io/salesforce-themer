 ...
 * The <one-app-launcher-modal> wrapper ships with SF's default light
 * surface background, which shows as a near-white band behind the modal
 * on every theme and reads as a "weird backdrop layer." Paint it with
 * the theme's page background so the app launcher feels like a themed
 * fullscreen view rather than a modal dropped on an unthemed page.
 * (Using background rather than transparent — transparency exposes
 * SF unthemed page-home layer underneath, which is worse.) */
