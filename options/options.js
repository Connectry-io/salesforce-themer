(() => {
    ...
    <div class="editor-preview-frame">
      ...
      <div class="preview-topbar" data-bind="surface" data-bind-border-color="border">
        <div class="preview-topbar-left">
          <svg class="preview-sf-logo" width="16" height="12" viewBox="0 0 24 16" fill="none" aria-hidden="true">
            <path d="M10 1.5a5 5 0 00-9 2.8 3.8 3.8 0 00.5 7.5h2.2a4.5 4.5 0 014-6.5 5.2 5.2 0 019.6-.2A4 4 0 0121.5 9a3.5 3.5 0 01-.3 7H18a4.5 4.5 0 00-3.6-6.8A5 5 0 0010 1.5z" fill="currentColor" opacity="0.5"/>
          </svg>
        </div>
  ...
  function applyEditorPreviewTypography() {
    ...
    const tiers = [
      ...
      { sel: '.preview-topbar-search span', base: 10 },
